...
{
    public static class AnomalyFunction
    {
        [FunctionName("AnomalyFunction")]
        public static IActionResult Run([HttpTrigger(AuthorizationLevel.Anonymous, "get", "post", Route = null)]HttpRequest req, TraceWriter log)
        {
            ...
            msg.SetSubject("Warning - Anomaly");

            msg.AddContent(MimeType.Text, $"An anomlay was just recorded with the following sentiment score {sentimentScore}. The tweet contained the following text: {body}");
